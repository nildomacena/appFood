...
export var Wrapper_CategoriesPage = (function () {
    function Wrapper_CategoriesPage(p0, p1) {
        this.changed = false;
        this.context = new import0.CategoriesPage(p0, p1);
    }
    Wrapper_CategoriesPage.prototype.detectChangesInternal = function (view, el, throwOnChange) {
        var changed = this.changed;
        this.changed = false;
        return changed;
    };
    return Wrapper_CategoriesPage;
}());
var renderType_CategoriesPage_Host = null;
var _View_CategoriesPage_Host0 = (function (_super) {
    __extends(_View_CategoriesPage_Host0, _super);
    function _View_CategoriesPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_CategoriesPage_Host0, renderType_CategoriesPage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_CategoriesPage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-categories', rootSelector, null);
        this._appEl_0 = new import3.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_CategoriesPage0(this.viewUtils, this.injector(0), this._appEl_0);
        ...
        this._appEl_0.initComponent(this._CategoriesPage_0_4.context, [], compView_0);
        compView_0.create(this._CategoriesPage_0_4.context, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_CategoriesPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.CategoriesPage) && (0 === requestNodeIndex))) {
            return this._CategoriesPage_0_4.context;
        }
        return notFoundResult;
    };
    _View_CategoriesPage_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._CategoriesPage_0_4.detectChangesInternal(this, this._el_0, throwOnChange);
        this.detectContentChildrenChanges(throwOnChange);
        this.detectViewChildrenChanges(throwOnChange);
    };
    return _View_CategoriesPage_Host0;
}(import1.AppView));
function viewFactory_CategoriesPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_CategoriesPage_Host === null)) {
        (renderType_CategoriesPage_Host = viewUtils.createRenderComponentType('', 0, import10.ViewEncapsulation.None, [], {}));
    }
    return new _View_CategoriesPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var CategoriesPageNgFactory = new import11.ComponentFactory('page-categories', viewFactory_CategoriesPage_Host0, import0.CategoriesPage);
var styles_CategoriesPage = [];
var renderType_CategoriesPage = null;
var _View_CategoriesPage0 = (function (_super) {
    __extends(_View_CategoriesPage0, _super);
    function _View_CategoriesPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_CategoriesPage0, renderType_CategoriesPage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_CategoriesPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_11 = this.renderer.createText(null, 'Categories', null);
    ...
    _View_CategoriesPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_CategoriesPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_11 = this.context.categories;
    ...
    _View_CategoriesPage0.prototype.destroyInternal = function () {
        this._Icon_7_3.context.ngOnDestroy();
        this._Icon_17_3.context.ngOnDestroy();
        this._Content_23_4.context.ngOnDestroy();
    };
    _View_CategoriesPage0.prototype._handle_click_5_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._MenuToggle_5_5.context.toggle() !== false);
        return (true && pd_0);
    };
    return _View_CategoriesPage0;
}(import1.AppView));
export function viewFactory_CategoriesPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_CategoriesPage === null)) {
        (renderType_CategoriesPage = viewUtils.createRenderComponentType('', 0, import10.ViewEncapsulation.None, styles_CategoriesPage, {}));
    }
    return new _View_CategoriesPage0(viewUtils, parentInjector, declarationEl);
}
var _View_CategoriesPage1 = (function (_super) {
    __extends(_View_CategoriesPage1, _super);
    function _View_CategoriesPage1(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_CategoriesPage1, renderType_CategoriesPage, import6.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_CategoriesPage1.prototype.createInternal = function (rootSelector) {
    ...
    _View_CategoriesPage1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_CategoriesPage1.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_3 = 'light';
    ...
    _View_CategoriesPage1.prototype._handle_click_0_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.parent.context.viewCategory(this.context.$implicit.id) !== false);
        return (true && pd_0);
    };
    return _View_CategoriesPage1;
}(import1.AppView));
function viewFactory_CategoriesPage1(viewUtils, parentInjector, declarationEl) {
