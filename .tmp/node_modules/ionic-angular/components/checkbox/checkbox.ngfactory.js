...
import * as import0 from 'ionic-angular/components/checkbox/checkbox';
...
export var Wrapper_Checkbox = (function () {
    ...
    Wrapper_Checkbox.prototype.detectChangesInternal = function (view, el, throwOnChange) {
...
var _View_Checkbox_Host0 = (function (_super) {
    ...
    function _View_Checkbox_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_Checkbox_Host0, renderType_Checkbox_Host, import7.ViewType.HOST, viewUtils, parentInjector, declarationEl, import1.ChangeDetectorStatus.CheckAlways);
    }
    Object.defineProperty(_View_Checkbox_Host0.prototype, "_NG_VALUE_ACCESSOR_0_5", {
        get: function () {
            if ((this.__NG_VALUE_ACCESSOR_0_5 == null)) {
                (this.__NG_VALUE_ACCESSOR_0_5 = [this._Checkbox_0_4.context]);
            }
    ...
    _View_Checkbox_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._Checkbox_0_4 = new Wrapper_Checkbox(this.parentInjector.get(import8.Config), this.parentInjector.get(import9.Form), this.parentInjector.get(import10.Item, null), new import11.ElementRef(this._el_0), this.renderer);
        this._appEl_0.initComponent(this._Checkbox_0_4.context, [], compView_0);
        compView_0.create(this._Checkbox_0_4.context, this.projectableNodes, null);
    ...
    _View_Checkbox_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.Checkbox) && (0 === requestNodeIndex))) {
            return this._Checkbox_0_4.context;
        }
    ...
    _View_Checkbox_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._Checkbox_0_4.detectChangesInternal(this, this._el_0, throwOnChange);
        this.detectContentChildrenChanges(throwOnChange);
        if (!throwOnChange) {
            if ((this.numberOfChecks === 0)) {
                this._Checkbox_0_4.context.ngAfterContentInit();
            }
        }
        var currVal_1 = this._Checkbox_0_4.context._disabled;
...
export var CheckboxNgFactory = new import14.ComponentFactory('ion-checkbox', viewFactory_Checkbox_Host0, import0.Checkbox);
var styles_Checkbox = [];
...
var _View_Checkbox0 = (function (_super) {
    ...
    function _View_Checkbox0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_Checkbox0, renderType_Checkbox, import7.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import1.ChangeDetectorStatus.CheckAlways);
    }
    _View_Checkbox0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_2 = import15.viewFactory_Button0(this.viewUtils, this.injector(2), this._appEl_2);
        this._Button_2_4 = new import15.Wrapper_Button(null, 'item-cover', this.parentInjector.get(import8.Config), new import11.ElementRef(this._el_2), this.renderer);
    ...
    _View_Checkbox0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import16.Button) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
...
export function viewFactory_Checkbox0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_Checkbox === null)) {
        (renderType_Checkbox = viewUtils.createRenderComponentType('', 0, import13.ViewEncapsulation.None, styles_Checkbox, {}));
    }
